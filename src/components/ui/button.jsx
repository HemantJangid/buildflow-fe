  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all cursor-pointer disabled:cursor-default disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        // On primary-colored banner (e.g. install app)
        inverse:
          "bg-primary-foreground text-primary font-medium hover:opacity-90",
        // Warning / session refresh primary action
        warning:
          "bg-amber-600 text-white hover:bg-amber-700 focus-visible:ring-amber-500/30 dark:bg-amber-600 dark:hover:bg-amber-700",
        // Warning secondary (e.g. Dismiss in session banner)
        warningSecondary:
          "bg-amber-100 text-amber-800 hover:bg-amber-200 focus-visible:ring-amber-500/30 dark:bg-amber-900/30 dark:text-amber-200 dark:hover:bg-amber-800/50",
      },
      size: {
